    ...
    <div class="container">
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tbody v-for="(category, index) in categories.data">
                    <tr
                        ...
                        <td class="px-6 py-4">
                            <img :src="category.main_image" class="w-16 h-14 md:w-20 max-w-full max-h-full"
                                :alt="category.name" />
                        </td>
                        <td class="px-6 py-4 flex flex-col md:flex-row">

                            <button type="button" @click="destroy(category.id)"
                                class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        ...
        <!-- Pagination -->
        <div v-if="categories.links && categories.links.length > 1" class="flex justify-center mt-6">
